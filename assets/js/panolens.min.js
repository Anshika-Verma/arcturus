(function(h, e) {
    ...
    function ba(a, b) {
        ...
        this.update = function(a) {
            ...
            E = 1;
            F.set(0, 0, 0);
            if (1e-7 < M.distanceToSquared(this.object.position) || 1e-7 < 8 * (1 - N.dot(this.object.quaternion))) !0 !== a && this.dispatchEvent(V),
                ...
                if (1 === d)
                    if (0 < this._repeat) {
                        ...
                        for (b in this._valuesStartRepeat) "string" === typeof this._valuesEnd[b] && (this._valuesStartRepeat[b] += parseFloat(this._valuesEnd[b])),
                            this._yoyo && ((d = this._valuesStartRepeat[b]), (this._valuesStartRepeat[b] = this._valuesEnd[b]), (this._valuesEnd[b] = d)), (this._valuesStart[b] = this._valuesStartRepeat[b]);
        ...
        c.Interpolation = {
            ...
            Bezier: function(a, b) {
                for (var d = 0,
                        ...
                        h = 0; h <= g; h++) d += e(1 - b, g - h) * e(b, h) * a[h] * l(g, h);
                return d;
            },
            ...
            Utils: {
                ...
                CatmullRom: function(a, b, c, e, m) {
                    ...
                    var d = m * m;
                    return (
                        (2 * b - 2 * c + a + e) * m * d + (-3 * b + 3 * c - 2 * a - e) * d + a * m + b);
                },
            },
        };
        a.exports = c;
    ...
    n.prototype = Object.assign(Object.create(e.Mesh.prototype), {
        ...
        add: function(a) {
            ...
            } else(b = new e.Object3D()), (b.scale.x = -1), (b.scalePlaceHolder = !0),
                b.add(a);
        ...
        composePanorama: function() {
            ...
            for (var d = this._parameters.useWebGL, e = 0; e < b; e++)
                for (var k = {}, h = 0; h < a; k = {
                    ...
                    (k.$jscomp$loop$prop$url$1 = "https://geo0.ggpht.com/cbk?cb_client=maps_sv.tactile&authuser=0&hl=en&output=tile&zoom=" + this._zoom + "&x=" + h + "&y=" + e + "&panoid=" + this._panoId + "&nbt&fover=2"), (function(a) {
                        return function(b, e) {
        ...
        onMouseMove: function(a) {
            switch ((a.touches && a.touches.length) || 1) {
                case 1:
                    ...
                    break;
                case 2:
                    (b = a.touches[0].pageX - a.touches[1].pageX), (a = a.touches[0].pageY - a.touches[1].pageY),
    ...
    da.prototype = Object.assign(Object.create(e.EventDispatcher.prototype), {
        ...
        onMouseUp: function(a) {
            ...
            if (!a || !a.target || a.target.classList.contains("panolens-canvas"))
                if (
                    (a.preventDefault(), (a = a.changedTouches && 1 === a.changedTouches.length ? this.onTap({
        ...
        onTap: function(a, b) {
            ...
            if (this.panorama) {
                ...
                if ("click" === b) this.panorama.dispatchEvent({
                    ...
                    if (
                        (this.hoverObject && 0 < c.length && this.hoverObject !== d) || (this.hoverObject && 0 === c.length)) this.hoverObject.dispatchEvent && (this.hoverObject.dispatchEvent({
                        type: "hoverleave",
                        mouseEvent: a,
